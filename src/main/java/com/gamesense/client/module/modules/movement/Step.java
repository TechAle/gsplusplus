...
public class Step extends Module {
    ...
    double[] betaTwo = {1.596759261951216, 1.929959255585439};
    ...
    */
    ...
    float getHeight(String mode) {
        ...
        return Float.parseFloat(mode.equals("Beta") ? bHeight.getValue() : mode.equals("Vanilla") ? vHeight.getValue() : height.getValue());
