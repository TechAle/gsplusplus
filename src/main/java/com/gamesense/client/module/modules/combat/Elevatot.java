...
public class Elevatot extends Module {
    ...
    ModeSetting page = registerMode("Page", Arrays.asList("Target", "Delay", "Checks", "Misc"), "Target");
    ModeSetting target = registerMode("Target", Arrays.asList("Nearest", "Looking"), "Nearest", () -> page.getValue().equals("Target"));
    IntegerSetting supportDelay = registerInteger("Support Delay", 0, 0, 8, () -> page.getValue().equals("Delay"));
    IntegerSetting pistonDelay = registerInteger("Piston Delay", 0, 0, 8, () -> page.getValue().equals("Delay"));
    IntegerSetting redstoneDelay = registerInteger("Redstone Delay", 0, 0, 8, () -> page.getValue().equals("Delay"));
    IntegerSetting blocksPerTick = registerInteger("Blocks per Tick", 4, 1, 8, () -> page.getValue().equals("Delay"));
    IntegerSetting tickBreakRedstone = registerInteger("Tick Break Redstone", 2, 0, 10, () -> page.getValue().equals("Delay"));
    DoubleSetting enemyRange = registerDouble("Range", 4.9, 0, 6, () -> page.getValue().equals("Target"));
    BooleanSetting debugMode = registerBoolean("Debug Mode", false, () -> page.getValue().equals("Misc"));
    BooleanSetting trapMode = registerBoolean("Trap Before", false, () -> page.getValue().equals("Misc"));
    BooleanSetting doubleTrap = registerBoolean("Double Trap", false, () -> page.getValue().equals("Misc"));
    BooleanSetting stopCa = registerBoolean("StopCa", false, () -> page.getValue().equals("Misc"));
    BooleanSetting rotate = registerBoolean("Rotate", false, () -> page.getValue().equals("Misc"));
    BooleanSetting clientInstaBreak = registerBoolean("Client Insta Break", false, () -> page.getValue().equals("Delay"));
    BooleanSetting clientInstaPlace = registerBoolean("Client Insta Place", false, () -> page.getValue().equals("Delay"));
    BooleanSetting pauseAfterSupport = registerBoolean("Pause After Support", false, () -> page.getValue().equals("Delay"));
    BooleanSetting checkPush = registerBoolean("Check Push", false, () -> page.getValue().equals("Checks"));
    BooleanSetting checkAbove = registerBoolean("Check Above", false, () -> page.getValue().equals("Checks"));
    BooleanSetting checkSurround = registerBoolean("Check Surround", true, () -> page.getValue().equals("Checks"));
    BooleanSetting checkBurrow = registerBoolean("Check Burrow", false, () -> page.getValue().equals("Checks"));
    BooleanSetting forceBurrow = registerBoolean("Force Burrow", false, () -> page.getValue().equals("Misc"));
    BooleanSetting stopOut = registerBoolean("Stop Out", true, () -> page.getValue().equals("Checks"));
    BooleanSetting noGlitchPiston = registerBoolean("No Glitch Piston", false, () -> page.getValue().equals("Misc"));
    IntegerSetting tickOutHole = registerInteger("Tick Out Hole", 0, 0, 10, () -> page.getValue().equals("Checks"));
    BooleanSetting fillHole = registerBoolean("Fill hole", false, () -> page.getValue().equals("Checks"));
    BooleanSetting addRoof = registerBoolean("Add Roof", false, () -> page.getValue().equals("Misc"));
    BooleanSetting silentSwitch = registerBoolean("Silent Switch", false, () -> page.getValue().equals("Misc"));
