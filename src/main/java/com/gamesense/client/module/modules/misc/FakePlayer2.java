...
@Module.Declaration(name = "FakePlayer2", category = Category.Misc)
public class FakePlayer2 extends Module {
    ...
    public void onEnable() {
        ...
        EntityOtherPlayerMP clonedPlayer = new EntityOtherPlayerMP(mc.world, new GameProfile(UUID.fromString("fdee323e-7f0c-4c15-8d1c-0f277442342a"), "Fit2"));
