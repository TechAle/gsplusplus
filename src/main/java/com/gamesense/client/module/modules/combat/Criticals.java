...
public class Criticals extends Module {
    ...
    BooleanSetting critCrystal = registerBoolean("Crit Crystals", false);
    ...
    private final Listener<PacketEvent.Send> listener = new Listener<>(event -> {
        if (event.getPacket() instanceof CPacketUseEntity && (!(event.getPacket() instanceof EntityEnderCrystal) || critCrystal.getValue()) && (!mc.player.isInWater() || !allowWater.getValue())) {
