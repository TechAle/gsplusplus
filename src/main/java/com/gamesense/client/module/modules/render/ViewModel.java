...
public class ViewModel extends Module {
    ...
    DoubleSetting xScaleRight = registerDouble("Right X Scale", 1, 0, 3);
    DoubleSetting yScaleRight = registerDouble("Right Y Scale", 1, 0, 3);
    DoubleSetting zScaleRight = registerDouble("Right Z Scale", 1, 0, 3);
