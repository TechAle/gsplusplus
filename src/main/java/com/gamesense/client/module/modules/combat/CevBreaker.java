...
public class CevBreaker extends Module {
    ...
    ModeSetting pages = registerMode("Pages", Arrays.asList("Target", "Rotation", "Delay", "BreakPlace", "Misc"), "Target");
    ModeSetting target = registerMode("Target", Arrays.asList("Nearest", "Looking"), "Nearest", () -> pages.getValue().equals("Target"));
    ModeSetting breakCrystal = registerMode("Break Crystal", Arrays.asList("Vanilla", "Packet", "None"), "Packet", () -> pages.getValue().equals("BreakPlace"));
    ModeSetting breakBlock = registerMode("Break Block", Arrays.asList("Normal", "Packet"), "Packet", () -> pages.getValue().equals("BreakPlace"));
    ...
    IntegerSetting supDelay = registerInteger("Support Delay", 1, 0, 4, () -> pages.getValue().equals("Delay"));
    IntegerSetting crystalDelay = registerInteger("Crystal Delay", 2, 0, 20, () -> pages.getValue().equals("Delay"));
    IntegerSetting blocksPerTick = registerInteger("Blocks Per Tick", 4, 2, 6, () -> pages.getValue().equals("Delay"));
    IntegerSetting hitDelay = registerInteger("Hit Delay", 2, 0, 20, () -> pages.getValue().equals("Delay"));
    IntegerSetting midHitDelay = registerInteger("Mid Hit Delay", 1, 0, 20, () -> pages.getValue().equals("Delay"));
    IntegerSetting endDelay = registerInteger("End Delay", 1, 0, 20, () -> pages.getValue().equals("Delay"));
    IntegerSetting pickSwitchTick = registerInteger("Pick Switch Tick", 100, 0, 500, () -> pages.getValue().equals("Misc"));
    BooleanSetting rotate = registerBoolean("Rotate", false, () -> pages.getValue().equals("Rotation"));
    BooleanSetting confirmBreak = registerBoolean("No Glitch Break", true, () -> pages.getValue().equals("BreakPlace"));
    BooleanSetting confirmPlace = registerBoolean("No Glitch Place", true, () -> pages.getValue().equals("BreakPlace"));
    BooleanSetting antiWeakness = registerBoolean("Anti Weakness", false, () -> pages.getValue().equals("Misc"));
    BooleanSetting switchSword = registerBoolean("Switch Sword", false, () -> pages.getValue().equals("Misc"));
    BooleanSetting fastPlace = registerBoolean("Fast Place", false, () -> pages.getValue().equals("BreakPlace"));
    BooleanSetting fastBreak = registerBoolean("Fast Break", true, () -> pages.getValue().equals("BreakPlace"));
    BooleanSetting trapPlayer = registerBoolean("Trap Player", false, () -> pages.getValue().equals("BreakPlace"));
    BooleanSetting antiStep = registerBoolean("Anti Step", false, () -> pages.getValue().equals("BreakPlace"));
    BooleanSetting placeCrystal = registerBoolean("Place Crystal", true, () -> pages.getValue().equals("BreakPlace"));
    BooleanSetting forceRotation = registerBoolean("Force Rotation", false, () -> pages.getValue().equals("Rotation"));
    BooleanSetting forceBreaker = registerBoolean("Force Breaker", false, () -> pages.getValue().equals("Rotation"));
