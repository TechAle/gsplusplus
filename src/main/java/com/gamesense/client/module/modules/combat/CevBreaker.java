...
public class CevBreaker extends Module {
    ...
    BooleanSetting breakPlaceSection = registerBoolean("Break Place Section", true);
    ModeSetting breakCrystal = registerMode("Break Crystal", Arrays.asList("Vanilla", "Packet", "None"), "Packet", () -> breakPlaceSection.getValue());
    ModeSetting breakBlock = registerMode("Break Block", Arrays.asList("Normal", "Packet"), "Packet", () -> breakPlaceSection.getValue());
    BooleanSetting fastPlace = registerBoolean("Fast Place", false, () -> breakPlaceSection.getValue());
    BooleanSetting fastBreak = registerBoolean("Fast Break", true, () -> breakPlaceSection.getValue());
    BooleanSetting trapPlayer = registerBoolean("Trap Player", false, () -> breakPlaceSection.getValue());
    BooleanSetting antiStep = registerBoolean("Anti Step", false, () -> breakPlaceSection.getValue());
    BooleanSetting placeCrystal = registerBoolean("Place Crystal", true, () -> breakPlaceSection.getValue());
    BooleanSetting confirmBreak = registerBoolean("No Glitch Break", true, () -> breakPlaceSection.getValue());
    BooleanSetting confirmPlace = registerBoolean("No Glitch Place", true, () -> breakPlaceSection.getValue());
    ...
    BooleanSetting forceBreaker = registerBoolean("Force Breaker", false, () -> rotationSection.getValue());
    ...
    IntegerSetting supDelay = registerInteger("Support Delay", 1, 0, 4, () -> delaySection.getValue());
    IntegerSetting crystalDelay = registerInteger("Crystal Delay", 2, 0, 20, () -> delaySection.getValue());
    IntegerSetting blocksPerTick = registerInteger("Blocks Per Tick", 4, 2, 6, () -> delaySection.getValue());
    IntegerSetting hitDelay = registerInteger("Hit Delay", 2, 0, 20, () -> delaySection.getValue());
    IntegerSetting midHitDelay = registerInteger("Mid Hit Delay", 1, 0, 20, () -> delaySection.getValue());
    IntegerSetting endDelay = registerInteger("End Delay", 1, 0, 20, () -> delaySection.getValue());
    BooleanSetting miscSection = registerBoolean("Misc Section", true);
    IntegerSetting pickSwitchTick = registerInteger("Pick Switch Tick", 100, 0, 500, () -> miscSection.getValue());
    BooleanSetting antiWeakness = registerBoolean("Anti Weakness", false, () -> miscSection.getValue());
    BooleanSetting switchSword = registerBoolean("Switch Sword", false, () -> miscSection.getValue());
