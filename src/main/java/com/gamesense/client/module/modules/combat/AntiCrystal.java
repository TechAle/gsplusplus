...
public class AntiCrystal extends Module {
    ...
    DoubleSetting rangePlace = registerDouble("Range Place", 5.9, 0, 6, () -> targetSection.getValue());
    DoubleSetting enemyRange = registerDouble("Enemy Range", 12, 0, 20, () -> targetSection.getValue());
    BooleanSetting onlyIfEnemy = registerBoolean("Only If Enemy", true, () -> targetSection.getValue());
    BooleanSetting damageSection = registerBoolean("Damage Section", true);
    DoubleSetting damageMin = registerDouble("Damage Min", 4, 0, 15, () -> damageSection.getValue());
    DoubleSetting biasDamage = registerDouble("Bias Damage", 1, 0, 3, () -> damageSection.getValue());
    BooleanSetting checkDamage = registerBoolean("Damage Check", true, () -> damageSection.getValue());
    BooleanSetting notOurCrystals = registerBoolean("Ignore AutoCrystal", true, () -> damageSection.getValue());
    BooleanSetting delaySection = registerBoolean("Delay Section", true);
    ModeSetting blockPlaced = registerMode("Block Place", Arrays.asList("Pressure", "String"), "String", () -> delaySection.getValue());
    IntegerSetting tickDelay = registerInteger("Tick Delay", 5, 0, 10, () -> delaySection.getValue());
    IntegerSetting blocksPerTick = registerInteger("Blocks Per Tick", 4, 0, 8, () -> delaySection.getValue());
    BooleanSetting miscSection = registerBoolean("Misc Section", true);
    BooleanSetting offHandMode = registerBoolean("OffHand Mode", true, () -> miscSection.getValue());
    BooleanSetting rotate = registerBoolean("Rotate", false, () -> miscSection.getValue());
    BooleanSetting nonAbusive = registerBoolean("Non Abusive", true, () -> miscSection.getValue());
    BooleanSetting switchBack = registerBoolean("Switch Back", true, () -> miscSection.getValue());
