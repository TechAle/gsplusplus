...
public class Announcer extends Module {
    ...
    public static String walkMessage = "I just walked{blocks} meters thanks to gs++!";
    public static String placeMessage = "I just inserted{amount}{name} into the muliverse thanks to gs++!";
    public static String jumpMessage = "I just hovered in the air thanks to gs++!";
    public static String breakMessage = "I just snapped{amount}{name} out of existance thanks to gs++!";
    public static String attackMessage = "I just disembowed{name} with a{item} thanks to gs++!";
    public static String eatMessage = "I just gobbled up{amount}{name} thanks to gs++!";
    public static String guiMessage = "I just opened my advanced hacking console thanks to gs++!";
