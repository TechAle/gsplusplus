...
public class PistonCrystal extends Module {
    ...
    ModeSetting pages = registerMode("Pages", Arrays.asList("Target", "PlaceBreak", "Delay", "Rotation", "Misc"), "Target");
    ModeSetting breakType = registerMode("Type", Arrays.asList("Swing", "Packet"), "Swing", () -> pages.getValue().equals("PlaceBreak"));
    ModeSetting placeMode = registerMode("Place", Arrays.asList("Torch", "Block", "Both"), "Torch", () -> pages.getValue().equals("PlaceBreak"));
    ModeSetting target = registerMode("Target", Arrays.asList("Nearest", "Looking"), "Nearest", () -> pages.getValue().equals("Target"));
    DoubleSetting enemyRange = registerDouble("Range", 4.9, 0, 6, () -> pages.getValue().equals("Target"));
    DoubleSetting crystalDeltaBreak = registerDouble("Center Break", 0.1, 0, 0.5, () -> pages.getValue().equals("PlaceBreak"));
    IntegerSetting crystalPlaceTry = registerInteger("Crystal Place Try", 15, 2, 30, () -> pages.getValue().equals("PlaceBreak"));
    IntegerSetting blocksPerTick = registerInteger("Blocks Per Tick", 4, 0, 20, () -> pages.getValue().equals("PlaceBreak"));
    IntegerSetting minHealth = registerInteger("Min Health", 8, 0, 20, () -> pages.getValue().equals("Target"));
    IntegerSetting supBlocksDelay = registerInteger("Surround Delay", 4, 0, 20, () -> pages.getValue().equals("Delay"));
    IntegerSetting preRotationDelay = registerInteger("Pre Rotation Delay", 0, 0, 20, () -> pages.getValue().equals("Rotation"));
    IntegerSetting afterRotationDelay = registerInteger("After Rotation Delay", 0, 0, 20, () -> pages.getValue().equals("Rotation"));
    IntegerSetting startDelay = registerInteger("Start Delay", 4, 0, 20, () -> pages.getValue().equals("Delay"));
    IntegerSetting pistonDelay = registerInteger("Piston Delay", 2, 0, 20, () -> pages.getValue().equals("Delay"));
    IntegerSetting crystalDelay = registerInteger("Crystal Delay", 2, 0, 20, () -> pages.getValue().equals("Delay"));
    IntegerSetting redstoneDelay = registerInteger("Redstone Delay", 0, 0, 20, () -> pages.getValue().equals("Delay"));
    IntegerSetting midHitDelay = registerInteger("Mid Hit Delay", 5, 0, 20, () -> pages.getValue().equals("Delay"));
    IntegerSetting hitDelay = registerInteger("Hit Delay", 2, 0, 20, () -> pages.getValue().equals("Delay"));
    IntegerSetting stuckDetector = registerInteger("Stuck Check", 35, 0, 200, () -> pages.getValue().equals("Delay"));
    IntegerSetting maxYincr = registerInteger("Max Y", 3, 0, 5, () -> pages.getValue().equals("PlaceBreak"));
    BooleanSetting blockPlayer = registerBoolean("Trap Player", true, () -> pages.getValue().equals("PlaceBreak"));
    BooleanSetting rotate = registerBoolean("Rotate", false, () -> pages.getValue().equals("Rotation"));
    BooleanSetting confirmBreak = registerBoolean("No Glitch Break", true, () -> pages.getValue().equals("PlaceBreak"));
    BooleanSetting confirmPlace = registerBoolean("No Glitch Place", true, () -> pages.getValue().equals("PlaceBreak"));
    BooleanSetting allowCheapMode = registerBoolean("Cheap Mode", false, () -> pages.getValue().equals("Misc"));
    BooleanSetting betterPlacement = registerBoolean("Better Place", true, () -> pages.getValue().equals("Misc"));
    BooleanSetting bypassObsidian = registerBoolean("Bypass Obsidian", false, () -> pages.getValue().equals("Misc"));
    BooleanSetting antiWeakness = registerBoolean("Anti Weakness", false, () -> pages.getValue().equals("Misc"));
    BooleanSetting debugMode = registerBoolean("Debug Mode", false, () -> pages.getValue().equals("Misc"));
    BooleanSetting speedMeter = registerBoolean("Speed Meter", false, () -> pages.getValue().equals("Misc"));
    BooleanSetting packetReducer = registerBoolean("Packet Reducer", false, () -> pages.getValue().equals("Rotation"));
    BooleanSetting preRotation = registerBoolean("Pre Rotation", false, () -> pages.getValue().equals("Rotation"));
    BooleanSetting forceRotation = registerBoolean("Force Rotation", false, () -> pages.getValue().equals("Rotation"));
    BooleanSetting chatMsg = registerBoolean("Chat Msgs", true, () -> pages.getValue().equals("Misc"));
