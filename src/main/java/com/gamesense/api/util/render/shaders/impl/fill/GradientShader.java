...
public class GradientShader extends FramebufferShader {
    ...
    public void updateUniforms (float duplicate, float moreGradient, float creepy, float alpha) {
    ...
    public void stopDraw(final Color color, final float radius, final float quality, float duplicate, float moreGradient, float creepy, float alpha ) {
        ...
        startShader(duplicate, moreGradient, creepy, alpha);
    ...
    public void startShader(float duplicate, float moreGradient, float creepy, float alpha) {
        GL11.glPushMatrix();
        ...
        this.updateUniforms(duplicate, moreGradient, creepy, alpha);
    }
