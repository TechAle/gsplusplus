    ...
    public void drawChat(int updateCounter) {
        ...
        if (this.mc.gameSettings.chatVisibility != EntityPlayer.EnumChatVisibility.HIDDEN) {
            ...
            if (j > 0) {
                ...
                if (chatModifier.smooth.getValue() && !this.isScrolled) GlStateManager.translate(2.0F + chatModifier.leftPosition.getValue(), 8.0F - chatModifier.upPosition.getValue() + (9 - 9*percent)*f1, 0.0F);
                else GlStateManager.translate(2.0F + chatModifier.leftPosition.getValue(), 8.0F - chatModifier.upPosition.getValue(), 0.0F);
                    ...
                    if (chatline != null) {
                        ...
                        if (j1 < 200 || flag) {
                            ...
                            if (l1 > 3) {
                                ...
                                if (chatModifier.smooth.getValue() && i1 <= newLines) {
